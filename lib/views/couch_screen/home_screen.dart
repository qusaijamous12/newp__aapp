...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    Future.delayed(Duration.zero,()async{
      await _userController.getAllCoachAnnouncment();
    });
    super.initState();
  }
      ...
      children: [
          ...
          child: CarouselSlider(
              ...
              items: [
                ...
                Container(
                    ...
                    clipBehavior: Clip.antiAliasWithSaveLayer,
                    child:const Image(image: NetworkImage('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTuADGAhVAMK5jPhwH7Yq3vZclk9mg4d4ywhQ&s'),fit: BoxFit.cover,)),
        ...
        Expanded(
          child: ConditionalBuilder(
              ...
              fallback: (context){
                if(_userController.announcmentCoachModel.isNotEmpty){
                  return ListView.builder(

                    itemCount: _userController.announcmentCoachModel.length,
                    itemBuilder: (context, index) =>buildAnnouncmentItem(_userController.announcmentCoachModel[index]),
                  );
                }
                else {
